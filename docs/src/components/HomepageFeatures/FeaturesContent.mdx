...
> **Mar 15, 2026** Eldiron v0.9.1 has been released, bringing new global rules, localization, audio FX, much better realtime visual scripting debugging, and many workflow improvements. Read the blog [here](blog/2026/03/15/eldiron-v0.9.1).
>
