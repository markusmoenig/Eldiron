...
- The **Sector Tool** selects and edits object faces.

This keeps the 2D editor vocabulary intact while giving the 3D path direct object, face, edge, and vertex editing.

The 3D editor works with Geometry Objects. The 2D map data can still be used for gameplay zones, triggers, and minimaps.
