...
This page collects all audio-related authoring workflow in one place.
...
Use asset names in the ruleset audio configuration below.

## Audio FX

Small procedural effects can be defined in **Game / Audio FX** as TOML.

Generated effects can be referenced by name in ruleset audio settings.
