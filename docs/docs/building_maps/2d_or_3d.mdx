...
3D editing has two complementary workflows:

- `GEOM` for structural world editing.
- `DETAIL` for editing wall, floor, and ceiling surface profiles directly in the 3D view.

This lets you stay in the 3D editor while creating openings, windows, gates, recesses, and other surface-local detail.
