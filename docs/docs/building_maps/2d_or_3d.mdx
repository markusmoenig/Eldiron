...
- The **Linedef Tool** edits object edges.
- The **Sector Tool** edits object faces and surface tiles.

The 3D editor works with Geometry Objects. The 2D map data can still be useful for gameplay zones, triggers, and minimaps.
