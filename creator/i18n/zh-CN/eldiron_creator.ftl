...
action_copy_vcode = 复制 Visual Code
action_copy_vcode_desc = 将当前 Visual Code 模块复制到剪贴板。
action_paste_vcode = 粘贴 Visual Code
action_paste_vcode_desc = 从剪贴板导入 Visual Code 模块。
tool_authoring = 编写模式
