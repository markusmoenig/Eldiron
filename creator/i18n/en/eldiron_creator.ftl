...
status_action_edit_sector_item = Set the item which will be instantiated for the sector.
status_action_edit_sector_terrain = Set the terrain role of the sector.
...
status_action_edit_sector_visible = The visible state of the sector geometry.
...
status_action_editing_slice_pos = The vertical position of the 2D editing slice.
...
action_edit_sector_terrain = Terrain Role
action_edit_sector_terrain_none = None
action_edit_sector_terrain_exclude = Exclude
...
action_edit_vertex_terrain_smoothness = Smoothness
