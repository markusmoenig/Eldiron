...
status_create_pattern_needs_face = Crear patrón necesita al menos una cara 3D seleccionada.
status_create_pattern_no_fit = Crear patrón no pudo encajar el patrón en la cara seleccionada.
status_create_pattern_created = sellos de patrón de superficie creados.
...
action_create_pattern = Crear patrón
action_create_pattern_desc = Crea guías editables de patrón con líneas de superficie 3D en las caras seleccionadas para acciones posteriores de recorte, cara, relieve o ranura.
...
action_cut_profile = Cortar perfil
action_cut_profile_desc = Corta un perfil repetido, como almenas, en todo el Geometry Object seleccionado.
...
action_first_p_camera_desc = Edita en primera persona 3D. Mantén pulsado el botón derecho y usa WASD para volar; Espacio es solo una alternativa para touchpad.
status_firstp_fly_nav_on = Navegación FirstP para touchpad activada. El puntero desde el centro gira/mira, WASD mueve, Espacio o Escape sale.
status_firstp_fly_nav_rmb_on = Navegación FirstP activada. Mantén pulsado el botón derecho para mirar, WASD mueve, suelta el botón derecho o pulsa Escape para salir.
status_firstp_fly_nav_off = Navegación FirstP desactivada.
...
status_camera_firstp = Edita el mapa en primera persona 3D. Mantén pulsado el botón derecho y usa WASD para volar; Espacio es solo una alternativa para touchpad.
