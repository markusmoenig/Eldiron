...
action_cut_hole = Cortar hueco
action_cut_hole_desc = Crea un recorte de perfil en el sector anfitrión a partir del sector interior seleccionado y conserva un manejador oculto enlazado para trabajo geométrico posterior.
...
action_build_procedural_help = Convierte la configuración [procedural] de la región actual en geometría editable del mapa. Usa mode = "2d" para mapas de baldosas o mode = "3d" para la ruta 3D reservada de dungeons.
action_build_shaft = Construir hueco
action_build_shaft_desc = Construye paredes reales del hueco y una tapa inferior opcional a partir de un sector manejador de recorte oculto.
action_build_stairs = Construir escaleras
action_build_stairs_desc = Construye una escalera física recta entre dos linedefs seleccionados.
...
action_window = Ventana
action_tile_procedural_style = Estilo
action_tile_procedural_kind = Tipo
action_tile_procedural_weight = Peso
action_window_desc = Crea una ventana estática (marco + vidrio) en el sector de perfil seleccionado.
