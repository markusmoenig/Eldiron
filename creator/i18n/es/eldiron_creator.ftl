...
tool_iso_paint = Herramienta Iso Paint (I). Pinta capas de belleza isométricas y detalles conscientes de la escena en la vista iso fija.
...
status_iso_paint_active = Iso Paint: haz clic o arrastra en la vista iso fija para previsualizar la colocación de pintura.
status_iso_paint_hit = Iso Paint: geometría encontrada para pintura de material.
status_iso_paint_ground = Iso Paint: ancla de mundo encontrada para pintura de detalle.
iso_paint_selected_brush = Pincel Iso Paint
...
iso_paint_brush_grass_desc = Coloca sellos de hierba/detalle orientados a iso y anclados al punto de impacto del mundo.
...
iso_paint_mode_screen = Pantalla
...
status_iso_paint_mode = Elige si el pincel escribe material de superficie, sellos de detalle de escena o pintura de pantalla.
status_iso_paint_size = Radio del pincel en unidades de mundo o relativas a pantalla.
