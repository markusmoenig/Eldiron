...
action_edit_vertex_desc = Edita los atributos del vértice seleccionado. Las posiciones XZ son el plano del suelo/2D. Y es altura.
...
tool_vertex = Herramienta de vértice (V).
