...
# Status
## Actions
status_action_add_arch_height = Altura de la curvatura del arco en XY.
status_action_add_arch_segment = Número de segmentos de la polilínea del arco.
status_action_edit_linedef_name = Establecer el nombre de la linedef.
status_action_edit_sector_name = Establecer el nombre del sector.
status_action_edit_sector_tags = Editar las etiquetas del sector.
status_action_edit_sector_terrain = Establecer el rol de terreno del sector.
status_action_edit_sector_terrain_ridge_height = In ridge mode, set the height of the ridge.
status_action_edit_sector_terrain_ridge_plateau = In ridge mode, set the width of the plateau.
status_action_edit_sector_terrain_ridge_falloff = In ridge mode, set the smoothness of the falloff.
status_action_edit_sector_visible = El estado de visibilidad de la geometría del sector.
status_action_edit_tile_role = Editar el rol de la baldosa.
status_action_edit_tile_blocking = Editar si la baldosa bloquea (solo juegos 2D).
status_action_edit_tile_tags = Editar las etiquetas de la baldosa.
...
status_action_extrude_linedef_distance = Distancia de extrusión (el signo define la dirección).
status_action_extrude_linedef_angle = Ángulo de rotación alrededor del eje / normal de la geometría.
status_action_editing_slice_pos = Posición vertical del corte de edición 2D.
status_action_extrude_sector_surface_extrusion = Cuando hay un sector (superficie) seleccionado: activar/desactivar extrusión para esa superficie.
status_action_extrude_sector_depth = Profundidad de la extrusión.
status_action_extrude_sector_open_back = Dejar la cara trasera abierta; útil para fachadas/interiores.
status_action_gate_door_inset = Retranqueo para la puerta / portón.
status_action_gate_door_tile = Baldosa para la puerta / portón.
status_action_gate_door_repeat_mode = Modo de repetición para la puerta / portón.
status_action_new_tile_size = Tamaño de la nueva baldosa.
status_action_new_tile_frames = Número de fotogramas de la nueva baldosa.
status_action_recess_depth = Profundidad del hueco.
status_action_recess_target = El hueco puede colocarse en la cara frontal o trasera.
status_action_recess_tiles = Baldosas de tapa y laterales (jamba) del hueco.
status_action_relief_height = Altura del relieve.
status_action_relief_target = El relieve puede colocarse en la cara frontal o trasera.
status_action_relief_tiles = Baldosas de tapa y laterales (jamba) del relieve.
status_action_set_tile_material_roughness = Componente de rugosidad del material.
status_action_set_tile_material_metallic = Componente metálico del material.
status_action_set_tile_material_opacity = Componente de opacidad del material.
...
status_play_button = Iniciar el servidor para edición y depuración en vivo.
status_pause_button = Pausar. Clic para ejecutar el servidor paso a paso.
...
action_edit_linedef_name = Nombre de la linedef
...
action_edit_sector_name = Nombre del sector
action_edit_sector_tags = Etiquetas del sector
action_edit_sector_terrain = Rol de terreno
action_edit_sector_terrain_none = Ninguno
action_edit_sector_terrain_exclude = Excluir
action_edit_sector_terrain_ridge = Ridge
action_edit_sector_terrain_ridge_height = Ridge Height
action_edit_sector_terrain_ridge_plateau = Ridge Plateau
action_edit_sector_terrain_ridge_falloff = Ridge Falloff
action_edit_sector_visible = Visible
...
action_edit_vertex_name = Nombre del vértice
action_edit_vertex_terrain_control = Terreno
action_edit_vertex_terrain_smoothness = Suavidad
...
action_editing_slice_pos = Posición Y
...
action_extrude_sector_surface_extrusion = Extrusión de superficie
action_extrude_sector_open_back = Cara trasera abierta
...
action_iso_camera_azimuth = Acimut
action_iso_camera_elevation = Elevación
