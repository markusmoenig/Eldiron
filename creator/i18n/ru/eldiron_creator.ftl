...
action_cut_hole = Вырезать проём
action_cut_hole_desc = Создаёт профильный вырез на выбранном базовом секторе по выбранному внутреннему сектору и сохраняет скрытую связанную геометрическую ручку для дальнейшей работы.
...
action_build_procedural_help = Преобразует конфигурацию [procedural] текущего региона в редактируемую геометрию карты. Используйте mode = "2d" для тайловых карт или mode = "3d" для зарезервированного пути 3D-подземелий.
action_build_shaft = Построить шахту
action_build_shaft_desc = Создаёт реальные стены шахты и, при необходимости, нижнюю крышку из скрытого сектора-ручки выреза.
action_build_stairs = Построить лестницу
action_build_stairs_desc = Создаёт прямую физическую лестницу между двумя выбранными linedef.
...
action_window_desc = Создает статическое окно (рама + стекло) в выбранном профильном секторе.
