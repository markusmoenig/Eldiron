...
tool_blocks = Инструмент блоков
status_block_tool_active = Инструмент блоков: щёлкните/перетащите для штампа, R повернуть, E стереть, В/Ш размер, D повреждения, [/] уровень
