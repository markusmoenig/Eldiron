...
action_copy_vcode = 複製 Visual Code
action_copy_vcode_desc = 將目前的 Visual Code 模組複製到剪貼簿。
action_paste_vcode = 貼上 Visual Code
action_paste_vcode_desc = 從剪貼簿匯入 Visual Code 模組。
tool_authoring = 編寫模式
