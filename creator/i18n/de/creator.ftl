...
# Status
## Actions
status_action_add_arch_height = Wölbungshöhe des Bogens in XY.
status_action_add_arch_segment = Anzahl der Segmente der Bogen-Polylinie.
status_action_edit_linedef_name = Den Namen der Linedef setzen.
status_action_edit_sector_name = Den Namen des Sektors setzen.
status_action_edit_sector_tags = Die Tags des Sektors bearbeiten.
status_action_edit_sector_terrain = Die Terrain-Rolle des Sektors setzen.
...
status_action_edit_sector_visible = Der Sichtbarkeitszustand der Sektorgeometrie.
status_action_edit_tile_role = Die Rolle der Kachel bearbeiten.
status_action_edit_tile_blocking = Bearbeiten, ob die Kachel blockiert (nur für 2D-Spiele).
status_action_edit_tile_tags = Die Tags der Kachel bearbeiten.
...
status_action_extrude_linedef_distance = Die Extrusionsdistanz (Vorzeichen bestimmt Richtung).
status_action_extrude_linedef_angle = Der Rotationswinkel um die Achse / Normale der Geometrie.
status_action_editing_slice_pos = Die vertikale Position des 2D-Bearbeitungsschnitts.
status_action_extrude_sector_surface_extrusion = Wenn ein Sektor (Fläche) ausgewählt ist: Extrusion für diese Fläche an-/ausschalten.
status_action_extrude_sector_depth = Die Extrusionstiefe.
status_action_extrude_sector_open_back = Die Rückseite offen lassen; nützlich für Fassaden / Innenräume.
status_action_gate_door_inset = Die Einrückung für Tor / Tür.
status_action_gate_door_tile = Die Kachel für Tor / Tür.
status_action_gate_door_repeat_mode = Der Wiederholmodus für Tor / Tür.
status_action_new_tile_size = Größe der neuen Kachel.
status_action_new_tile_frames = Anzahl der Frames für die neue Kachel
status_action_recess_depth = Die Tiefe der Vertiefung.
status_action_recess_target = Die Vertiefung kann an der Vorder- oder Rückseite liegen.
status_action_recess_tiles = Die Abschluss- und Seitenkacheln (Pfosten) der Vertiefung.
...
status_play_button = Den Server für Live-Bearbeitung und Debugging starten.
status_pause_button = Pausieren. Klicken zum Einzelschritt des Servers.
...
action_edit_sector_name = Sektorname
action_edit_sector_tags = Sektor-Tags
action_edit_sector_terrain = Terrain-Rolle
action_edit_sector_terrain_none = Keine
action_edit_sector_terrain_exclude = Ausschließen
...
action_edit_sector_visible = Sichtbar
...
action_edit_vertex_terrain_smoothness = Glättung
...
action_editing_slice_pos = Y-Position
...
action_extrude_sector_surface_extrusion = Oberflächenextrusion
action_extrude_sector_open_back = Offene Rückseite
...
action_iso_camera_azimuth = Azimut
