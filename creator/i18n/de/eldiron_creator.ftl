...
builder_apply_build = Build anwenden
...
status_builder_apply_build = Den ausgewählten Builder-Graphen auf die ausgewählten Hosts anwenden.
status_builder_clear_build = Den Builder-Graphen von den ausgewählten Hosts entfernen.
