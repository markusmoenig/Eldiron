...
action_copy_vcode = Visual Code kopieren
action_copy_vcode_desc = Kopiert das aktuelle Visual-Code-Modul in die Zwischenablage.
action_paste_vcode = Visual Code einfügen
action_paste_vcode_desc = Importiert ein Visual-Code-Modul aus der Zwischenablage.
