...
action_cut_hole = Loch schneiden
action_cut_hole_desc = Erzeugt aus dem ausgewählten inneren Sektor einen Profilausschnitt auf dem Host-Sektor und behält einen versteckten verknüpften Griff für nachfolgende Geometriearbeiten.
...
action_build_procedural_help = Baut die [procedural]-Konfiguration der aktuellen Region in bearbeitbare Kartengeometrie um. Verwende mode = "2d" für Tile-Karten oder mode = "3d" für den reservierten 3D-Dungeon-Pfad.
action_build_shaft = Schacht bauen
action_build_shaft_desc = Erzeugt echte Schachtwände und optional eine Bodenfläche aus einem versteckten Ausschnitt-Griffsektor.
action_build_stairs = Treppe bauen
action_build_stairs_desc = Erzeugt eine gerade physische Treppe zwischen zwei ausgewählten Linedefs.
...
action_window = Fenster
action_tile_procedural_style = Stil
action_tile_procedural_kind = Art
action_tile_procedural_weight = Gewicht
action_window_desc = Erstellt ein statisches Fenster (Rahmen + Glas) im ausgewählten Profilsektor.
