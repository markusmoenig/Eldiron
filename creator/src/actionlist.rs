...
impl ActionList {
    pub fn new() -> Self {
        let actions: Vec<Box<dyn Action>> = vec![
            ...
            Box::new(crate::tools::copy_vcode::CopyVCode::new()),
            Box::new(crate::tools::create_center_vertex::CreateCenterVertex::new()),
            Box::new(crate::tools::create_campfire::CreateCampfire::new()),
            Box::new(crate::tools::create_fence::CreateFence::new()),
            Box::new(crate::tools::create_geometry_box::CreateGeometryBox::new()),
            ...
            Box::new(crate::tools::cut_hole::CutHole::new()),
            ...
            Box::new(crate::tools::edit_geometry::EditGeometry::new()),
            ...
            Box::new(crate::tools::window::Window::new()),
