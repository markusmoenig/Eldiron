...
impl ActionList {
    pub fn new() -> Self {
        let actions: Vec<Box<dyn Action>> = vec![
            ...
            Box::new(crate::actions::create_fitted_geometry::CreateFittedGeometry::new()),
            Box::new(crate::actions::create_geometry_box::CreateGeometryBox::new()),
            Box::new(crate::actions::prefabs::CreateLinkedPrefab::new()),
            Box::new(crate::actions::prefabs::CreatePrefabCopy::new()),
            Box::new(crate::actions::prefabs::UpdatePrefabSource::new()),
            Box::new(crate::actions::prefabs::MakePrefabUnique::new()),
            Box::new(crate::actions::prefabs::UnpackPrefab::new()),
            ...
            Box::new(crate::actions::clear_surface_detail::ClearSurfaceDetail::new()),
