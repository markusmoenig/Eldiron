...
impl ActionList {
    pub fn new() -> Self {
        let actions: Vec<Box<dyn Action>> = vec![
            ...
            Box::new(crate::actions::add_arch::AddArch::new()),
            Box::new(crate::actions::apply_tile::ApplyTile::new()),
            Box::new(crate::actions::build_procedural::BuildProcedural::new()),
            Box::new(crate::actions::build_room::BuildRoom::new()),
            Box::new(crate::actions::build_stairs::BuildStairs::new()),
            Box::new(crate::actions::build_shaft::BuildShaft::new()),
            Box::new(crate::actions::clear_profile::ClearProfile::new()),
            Box::new(crate::actions::copy_tile_id::CopyTileID::new()),
            Box::new(crate::actions::copy_vcode::CopyVCode::new()),
            Box::new(crate::actions::create_center_vertex::CreateCenterVertex::new()),
            Box::new(crate::actions::create_campfire::CreateCampfire::new()),
            Box::new(crate::actions::create_fence::CreateFence::new()),
            Box::new(crate::actions::create_geometry_box::CreateGeometryBox::new()),
            Box::new(crate::actions::create_linedef::CreateLinedef::new()),
            Box::new(crate::actions::create_palisade::CreatePalisade::new()),
            Box::new(crate::actions::create_prop::CreateProp::new()),
            Box::new(crate::actions::create_roof::CreateRoof::new()),
            Box::new(crate::actions::create_sector::CreateSector::new()),
            Box::new(crate::actions::create_stairs::CreateStairs::new()),
            Box::new(crate::actions::cut_hole::CutHole::new()),
            ...
            Box::new(crate::actions::export_vcode::ExportVCode::new()),
            Box::new(crate::actions::filter_editing_geo::FilterEditingGeo::new()),
            Box::new(crate::actions::extrude_linedef::ExtrudeLinedef::new()),
            Box::new(crate::actions::extrude_sector::ExtrudeSector::new()),
            Box::new(crate::actions::gate_door::GateDoor::new()),
            Box::new(crate::actions::window::Window::new()),
            Box::new(crate::actions::import_vcode::ImportVCode::new()),
            Box::new(crate::actions::paste_vcode::PasteVCode::new()),
            ...
            Box::new(crate::actions::recess::Recess::new()),
            Box::new(crate::actions::relief::Relief::new()),
