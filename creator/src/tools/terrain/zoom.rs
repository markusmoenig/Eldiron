...
pub struct TerrainZoomTool {
    id: TheId,
}

impl Tool for TerrainZoomTool {
    fn new() -> Self
    where
        Self: Sized,
    {
        Self {
            id: TheId::named("Terrain Zoom Tool"),
        }
    }
    ...
    fn tool_event(
        ...
        if let Activate = tool_event {
            ...
            if let Some(layout) = ui.get_hlayout("Terrain Tool Params") {
                ...
                let mut zoom = TheTextLineEdit::new(TheId::named("TerrainMap Zoom"));
