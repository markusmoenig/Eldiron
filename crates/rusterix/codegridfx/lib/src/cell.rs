...
impl Cell {
    pub fn description(&self) -> &'static str {
        match self {
            ...
            Cell::FollowAttack => "Follow Attack",
            ...
            Cell::MultipleChoice => "Multiple Choice",
            Cell::Dialog => "Dialog",
            Cell::Patrol => "Patrol",
            Cell::PlayAudio => "Play Audio",
    ...
    pub fn from_str(s: &str) -> Option<Self> {
        match s {
            ...
            "follow_attack" => Some(Cell::FollowAttack),
            ...
            "multiple_choice" => Some(Cell::MultipleChoice),
            "dialog" => Some(Cell::Dialog),
            "patrol" => Some(Cell::Patrol),
            "play_audio" => Some(Cell::PlayAudio),
            ...
            "set_audio_bus_volume" => Some(Cell::SetAudioBusVolume),
            ...
            "set_target" => Some(Cell::SetTarget),
    ...
    pub fn to_string(&self) -> String {
        match &self {
            ...
            FollowAttack => "follow_attack".into(),
    ...
    pub fn status(&self) -> String {
        match &self {
            ...
            Say => "Display speech above an entity in the game view (optional category).".into(),
            ...
            MultipleChoice => "Offer script-defined choices to the given entity.".into(),
            Dialog => "Open a TOML-authored dialog node for the given entity.".into(),
            Patrol => "Patrol using attributes.route (patrol(wait, speed)).".into(),
            PlayAudio => "Play an audio asset: play_audio(name, bus, gain, looping).".into(),
            ...
            SetTarget => "Set current target entity ID for the current entity or item.".into(),
