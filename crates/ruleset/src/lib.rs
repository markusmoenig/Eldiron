...
pub fn bundled_texture_assets() -> &'static [BundledTextureAsset] {
    ...
    &[
        ...
        official_icon!("look"),
        official_icon!("use"),
        official_icon!("ui_inventory"),
        official_icon!("ui_equipment"),
        official_icon!("ui_preferences"),
        ...
        official_icon!("guard"),
        official_icon!("rally"),
        official_icon!("crushing_blow"),
        official_icon!("iron_guard"),
        official_icon!("executioner_strike"),
        official_icon!("aimed_shot"),
        official_icon!("quick_step"),
        official_icon!("piercing_shot"),
        official_icon!("hunter_focus"),
        official_icon!("deadly_shot"),
        official_icon!("minor_heal"),
        official_icon!("holy_light"),
        official_icon!("blessing"),
        official_icon!("turn_undead"),
        official_icon!("greater_heal"),
        official_icon!("smite"),
        official_icon!("sanctuary"),
        official_icon!("fire_spark"),
        official_icon!("gather_herbs"),
        official_icon!("gather_wood"),
        official_icon!("gather_feathers"),
        official_icon!("gather_moonleaf"),
        official_icon!("mine_sun_shards"),
        official_icon!("sift_grave_dust"),
        official_icon!("tap_ember_resin"),
        official_icon!("craft_blessed_herb"),
        official_icon!("craft_wooden_arrows"),
        official_icon!("craft_hunting_bow"),
        official_icon!("distill_moonwater"),
        official_icon!("prepare_consecrated_oil"),
        official_icon!("mix_warding_salt"),
        official_icon!("shape_ember_beads"),
        official_icon!("craft_ritual_censer"),
        official_icon!("craft_sunward_charm"),
...
mod tests {
    ...
    #[test]
    fn every_official_action_has_independent_bundled_artwork() {
        let textures =
            bundled_texture_assets_for_ruleset(OFFICIAL_RULESET_ID, OFFICIAL_RULESET_VERSION);
        for id in [
            "basic_attack",
            ...
            assert!(
                textures.iter().any(|asset| asset.id == id),
                "{id} should own a bundled icon file"
            );
        }
    }
