...
pub struct CodeEditorToolBar {
    rect                    : (usize, usize, usize, usize),
    pub widgets             : Vec<AtomWidget>,
}

impl Widget for CodeEditorToolBar {
    ...
    fn new(_text: Vec<String>, rect: (usize, usize, usize, usize), asset: &Asset, context: &mut ScreenContext) -> Self where Self: Sized {
        ...
        */
        ...
        let mut done_button = AtomWidget::new(vec!["Done".to_string()], AtomWidgetType::ToolBarCheckButton,
            AtomData::new_as_int("Done".to_string(), 0));
        done_button.set_rect((rect.2 - 110, rect.1, 100, rect.3), asset, context);
        widgets.push(done_button);
