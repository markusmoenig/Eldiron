...
class MetalStates {
    ...
    init(_ renderer: Renderer)
    {
        ...
        states[States.CopyTexture.rawValue] = createQuadState(name: "m4mCopyTextureDrawable", blending: false)
    ...
    func createQuadState( library: MTLLibrary? = nil, name: String, blending: Bool = true ) -> MTLRenderPipelineState?
    {
        ...
        do {
            ...
            pipelineStateDescriptor.colorAttachments[0].isBlendingEnabled = blending
