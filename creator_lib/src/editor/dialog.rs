...
impl DialogWidget {
    pub fn new(asset: &Asset, context: &ScreenContext) -> Self {
        ...
        let cancel_button = AtomWidget::new(
    ...
    pub fn draw(
        ...
        if context.dialog_state == DialogState::Opening {
            ...
            if context.dialog_height >= self.rect.3 {
                ...
                } else if context.dialog_entry == DialogEntry::NodeTime {
                    if let Some(v) = context.dialog_value.to_date() {
                        self.text = v.to_time24();
                    } else {
                        self.text = "".to_string();
                    }
                } else if context.dialog_entry == DialogEntry::NodeSize2D {
                    self.text = format!("{}", context.dialog_node_behavior_value.0);
                } else if context.dialog_entry == DialogEntry::NodeExpression
                ...
                } else if context.dialog_entry == DialogEntry::NodeTile {
                    self.tile_selector_widget.set_tile_type(
                        context.dialog_tile_usage.clone(),
                        None,
                        None,
                        &asset,
                    );
                ...
                } else if context.dialog_entry == DialogEntry::NewName
            ...
            self.dirty = true;
        } else if context.dialog_state == DialogState::Closing {
            context.dialog_height -= 20;
            rect.3 = context.dialog_height;
        ...
        if self.dirty {
            ...
            if context.dialog_state == DialogState::Open {
                ...
                if context.dialog_entry == DialogEntry::NodeNumber {
                    ...
                    } else if self.widgets[1].state == WidgetState::Disabled {
                        self.widgets[1].state = WidgetState::Normal;
                    }
                } else if context.dialog_entry == DialogEntry::NodeTime {
                    context.draw2d.draw_text(
                ...
                } else if context.dialog_entry == DialogEntry::NodeExpressionValue {
                    context.draw2d.draw_text(
                        buffer_frame,
                        &(40, 10),
                        rect.2,
                        &asset.get_editor_font("OpenSans"),
                        title_text_size,
                        &"Number Expression".to_string(),
                        &context.color_white,
                        &context.color_black,
                    );
                } else if context.dialog_entry == DialogEntry::NodeScript {
                    context.draw2d.draw_text(
                        buffer_frame,
                        &(40, 10),
                        rect.2,
                ...
                } else if context.dialog_entry == DialogEntry::NodeText {
                    context.draw2d.draw_text(
                        buffer_frame,
                        &(40, 10),
                        rect.2,
                ...
                } else if context.dialog_entry == DialogEntry::NodeGridSize {
                    context.draw2d.draw_text(
                        buffer_frame,
                        &(40, 10),
                        rect.2,
                ...
                } else if context.dialog_entry == DialogEntry::NewProjectName {
                    context.draw2d.draw_text(
                        buffer_frame,
                        &(40, 10),
                        rect.2,
                ...
                } else if context.dialog_entry == DialogEntry::Tags {
                    context.draw2d.draw_text(
                        buffer_frame,
                        &(40, 10),
                        rect.2,
                ...
                } else if context.dialog_entry == DialogEntry::NodeName {
                    context.draw2d.draw_text(
                        buffer_frame,
                        &(40, 10),
                        rect.2,
                    ...
                    context.draw2d.draw_text(
                        ...
                        &asset.get_editor_font("OpenSans"),
                        title_text_size,
                        &"Select Tile".to_string(),
                        &context.color_white,
                        &context.color_black,
                    );
                    self.tile_selector_widget.rect = input_rect.clone();
                    self.tile_selector_widget.draw(
                        buffer_frame,
                        rect.2,
                        anim_counter,
                        asset,
                ...
                if context.dialog_entry != DialogEntry::NodeTile {
                    context.draw2d.draw_rounded_rect_with_border(
                        ...
                        &input_rect,
                        rect.2,
                        &(input_rect.2 as f32 - 1.0, input_rect.3 as f32 - 1.0),
                        &context.color_black,
                        &(20.0, 20.0, 20.0, 20.0),
                        &border_color,
                        1.5,
