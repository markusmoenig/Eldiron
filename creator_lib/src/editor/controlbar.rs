...
impl Widget for ControlBar {
        ...
        Self: Sized,
    {
        ...
        let mut undo_button = AtomWidget::new(
            vec!["Undo".to_string()],
        ...
        let mut redo_button = AtomWidget::new(
            vec!["Redo".to_string()],
            AtomWidgetType::ToolBarButton,
        ...
        let mut demo_button = AtomWidget::new(
            vec!["Demo".to_string()],
        ...
        let mut game1_button = AtomWidget::new(
            vec!["G1".to_string()],
            AtomWidgetType::ToolBarCheckButton,
        ...
        let mut game2_button = AtomWidget::new(
            vec!["G2".to_string()],
            AtomWidgetType::ToolBarCheckButton,
        ...
        let mut game3_button = AtomWidget::new(
            vec!["G3".to_string()],
            AtomWidgetType::ToolBarCheckButton,
        ...
        let mut game4_button = AtomWidget::new(
            vec!["G4".to_string()],
            AtomWidgetType::ToolBarCheckButton,
        ...
        let mut help_button = AtomWidget::new(
            vec!["Help".to_string()],
            AtomWidgetType::ToolBarButton,
        ...
        let mut play_button = AtomWidget::new(
            vec!["Play".to_string()],
            AtomWidgetType::ToolBarButton,
        ...
        let mut debug_button = AtomWidget::new(
            vec!["Debug".to_string()],
            AtomWidgetType::ToolBarButton,
    ...
    fn mouse_down(
        ...
        for atom_widget in &mut self.widgets {
            if atom_widget.mouse_down(pos, asset, context) {
                ...
                } else if atom_widget.atom_data.id == "Game1" {
                    for i in ControlWidgets::Demo as usize..=ControlWidgets::Game4 as usize {
                        self.widgets[i].checked = false;
                        self.widgets[i].dirty = true;
                    }
                ...
                } else if atom_widget.atom_data.id == "Game2" {
                    for i in ControlWidgets::Demo as usize..=ControlWidgets::Game4 as usize {
                        self.widgets[i].checked = false;
                        self.widgets[i].dirty = true;
                    }
                ...
                } else if atom_widget.atom_data.id == "Game3" {
                    for i in ControlWidgets::Demo as usize..=ControlWidgets::Game4 as usize {
                        self.widgets[i].checked = false;
                        self.widgets[i].dirty = true;
                    }
                ...
                } else if atom_widget.atom_data.id == "Game4" {
                    for i in ControlWidgets::Demo as usize..=ControlWidgets::Game4 as usize {
                        self.widgets[i].checked = false;
                        self.widgets[i].dirty = true;
                    }
                ...
                } else if atom_widget.atom_data.id == "Help" {
                    self.show_help = true;
                } else if atom_widget.atom_data.id == "Debug" {
                ...
                } else if atom_widget.atom_data.id == "Play" {
                    if context.is_running == false {
                        context.is_running = true;
