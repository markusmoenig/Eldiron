...
impl NodeWidget {
    ...
    pub fn new_from_behavior_data(
        _behavior: &GameBehaviorData,
        ...
        Self {
            ...
            user_data: NodeUserData {
                position: behavior_node.position.clone(),
            },
    ...
    pub fn draw(
        ...
        let mut height = if self.is_corner_node == false {
            title_size + 25
        } else {
            22
        };
        ...
        if self.dirty {
            ...
            if self.is_corner_node {
                ...
                context.draw2d.draw_rounded_rect(
                    ...
                    &rect,
                    stride,
                    &((rect.2 - 1) as f32, (rect.3 - 2) as f32),
                    &self.color,
                    rounding,
                );
                ...
                context.draw2d.draw_rounded_rect_with_border(
                    ...
                    &rect,
                    stride,
                    &((rect.2 - 1) as f32, (rect.3 - 1) as f32),
                    title_color,
                    rounding,
                    &context.color_gray,
                    1.5,
                ...
                if self.widgets.is_empty() == false {
                    context.draw2d.draw_rounded_rect_with_border(
                        buffer_frame,
                        &(rect.0, rect.1 + title_size, rect.2, rect.3 - title_size),
                        stride,
                        &((rect.2 - 1) as f32, (rect.3 - title_size) as f32 - 2.5),
                        back_color,
                        rounding,
                        &context.color_gray,
                        0.0,
                ...
                if selected {
                    context.draw2d.draw_rounded_rect_with_border(
                        ...
                        &rect,
                        stride,
                        &((rect.2 - 1) as f32, (rect.3) as f32 - 2.5),
                        &[0, 0, 0, 0],
                        rounding,
                ...
                for atom_widget in &mut self.widgets {
                    context.draw2d.draw_text(
                        ...
                        stride,
                        &asset.get_editor_font("OpenSans"),
                        context.node_button_header_text_size,
                        &atom_widget.atom_data.text,
                        &[180, 180, 180, 255],
                        &context.color_black,
                    );
                ...
                if context.data.behaviors_ids.is_empty() == false {
                    if let Some(behavior) = context
                        .data
                        .behaviors
                        .get(&context.data.behaviors_ids[context.curr_behavior_index])
                    {
                        for (_source_node_id, _source_connector, dest_node_id, dest_connector) in
    ...
    pub fn draw_overview(
        ...
        if self.dirty {
            ...
            context.draw2d.draw_rounded_rect_with_border(
                ...
                rect.2,
                &((self.size.1 - 1) as f32, (self.size.1 - 1) as f32),
                &[0, 0, 0, 255],
                &(20.0, 20.0, 20.0, 20.0),
                &context.color_gray,
                1.5,
            ...
            context
                .draw2d
                .blend_slice(buffer_frame, preview_buffer, &(10, 10, 100, 100), rect.2);
                    ...
                    if let Some(widget_id) = self.widgets[index].behavior_id.clone() {
                        if id == widget_id {
                            context.data.set_behavior_id_value(
                                id.clone(),
                                self.widgets[index].atom_data.value.clone(),
